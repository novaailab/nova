...
Nova is free software, MIT licensed

## Get started
<CardGroup cols={2}>
  <Card title="Typescript SDK" icon="code" href="https://github.com/novaailab/nova/tree/main/typescript">
    Get started with the Typescript SDK
  </Card>
  <Card title="Python SDK" icon="python" href="https://github.com/novaailab/nova/tree/main/python">
...
## Follow us
<CardGroup cols={2}>
  <Card title="Github" icon="github" href="https://github.com/novaailab/nova">
